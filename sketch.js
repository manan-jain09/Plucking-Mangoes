...
function setup(){
    ...
    mango3 = new Mango(1100,260, 40);
    mango3 = new Mango(1100,260, 40);
    mango2 = new Mango(1000,280, 40);
    mango3 = new Mango(1100,260, 40);
    mango4 = new Mango(1200,260, 40);
    mango5 = new Mango(1100,200, 40);
    mango6 = new Mango(1125,150, 40);
    mango7 = new Mango(950,270, 40);
    mango8 = new Mango(910,260, 40);
    mango9 = new Mango(1250,280, 40);
